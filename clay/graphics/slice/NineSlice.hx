...
class NineSlice extends Mesh {
	...
	function updateWidth() {
		...
		vertices[1].pos.x = vertices[5].pos.x = vertices[9].pos.x = vertices[13].pos.x = _left * _edgeScale; 
		vertices[2].pos.x = vertices[6].pos.x = vertices[10].pos.x = vertices[14].pos.x = _width - _right * _edgeScale; 
	...
	function updateHeight() {
		...
		vertices[4].pos.y = vertices[5].pos.y = vertices[6].pos.y = vertices[7].pos.y = _top * _edgeScale; 
		vertices[8].pos.y = vertices[9].pos.y = vertices[10].pos.y = vertices[11].pos.y = _height - _bottom * _edgeScale; 
