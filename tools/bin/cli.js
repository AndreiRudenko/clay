...
if (process.version < "4.0.0") console.warn("Module " + (typeof(module) == "undefined" ? "" : module.filename) + " requires node.js version 4.0.0 or higher");
(function () { "use strict";
...
Config.create_khafile = function(config) {
	...
	if(config.android != null) {
		...
		if(config.android.permissions != null) {
			kfile += "p.targetOptions.android.permissions = \"" + Std.string(config.android.permissions) + "\";\n";
		}
		if(config.android.package) {
			kfile += "p.targetOptions.android.package = \"" + config.android.package + "\";\n";
		}
	}
	if(config.ios != null) {
